...
next you have to remove polish sight in "przymiotiki" ś ->s , ę ->e, ź ->z, ą -> a, ł ->l and blank space
next delete warm up and "Ubrania" '''

import csv

data = []
with open('C:/Users/Paweł/Desktop/Bad_III_proc/bada_III_d_merge_do_2106_do_pyth.csv', encoding="cp1252") as csvfile:
...
with open('C:/Users/Paweł/Desktop/Bad_III_proc/bada_III_d_merge_do_2106_fazio_to_spss.csv', 'w', newline='', encoding="cp1252") as outfile:
